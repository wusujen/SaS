...
public class GraphView extends SurfaceView implements Runnable {
	...
	public void getAddedContent(){
		float selectedCalories = selectedItems.get(0).getCalories();
		Log.d("GraphView", "SelectedItem " + selectedItems.get(0).getItemName() + " Selected Quantity: " + selectedQuantities.get(0));
		CALORIES_ADDED = ((selectedCalories * (float) selectedQuantities.get(0)) / 
				CALORIES_NEEDED );
	}
